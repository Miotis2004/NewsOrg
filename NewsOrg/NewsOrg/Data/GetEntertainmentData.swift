...
//
class GetEntertainmentData: ObservableObject {
    var didChange = PassthroughSubject<Void, Never>()
    
    var source = "https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=a53c806990674b42842537638c545e2f" {didSet {didChange.send()}}
